...
module.exports = React.createClass({displayName: 'exports',
  ...
  render: function() {
    ...
    employee_mining_job = React.DOM.a({href: "javascript:", 
    ...
    company_mining_job = React.DOM.a({href: "javascript:", 
               onClick: this.launchProspectProfileModal, 
               style: {display:'block'}, 
    ...
    prospect_title_mining_job = React.DOM.a({href: "javascript:", 
                   onClick: this.launchProspectProfileModal, 
                   style: {display:'block'}, 
    ...
    if(JSON.parse(localStorage.currentUser).accountType == "Staff")
      if(this.props.className == "Prospect")
        ...
        mining_job_btns = React.DOM.div(null, employee_mining_job, company_mining_job)
    else
      mining_job_btns = ""
