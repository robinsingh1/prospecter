...
module.exports = React.createClass({displayName: 'exports',
  ...
  render: function() {
    ...
    optionsMenu = React.DOM.div({style: {fontSize:10, cursor:'pointer',height:20,marginTop:-20}}, 
            ...
            React.DOM.a({className: "text-muted", onClick: this.reloadProspect, 
              style: {marginTop:5}}, 
    ...
    return (
      React.DOM.tr({className: "prospects-tr", 
          ...
          React.DOM.td({style: color, className: "fixed-data-column"}, 
            React.DOM.span({style: {fontWeight:'bold'}, className: "company-name-holder"}, 
              React.DOM.a({href: "javascript:", onClick: this.toggleDetailMode}, prospect_company_name)
            ), 
