    ...
    return (
      ...
      React.DOM.div({className: "col-lg-10 col-md-10 col-sm-10 col-xs-10", style: {padding:'0'}}, 
              ...
              React.DOM.div({id: "prospectDetailButtons"}, 
                ...
                React.DOM.div({className: "dropdown1 copyList", style: {display:'block'}}, 
                ...
                React.DOM.div({className: "dropdown1 moveList"}, 
                  React.DOM.a({'data-toggle': "dropdown", 
                     href: "javascript:", 
                     id: "moveToList", 
                     style: listOptions, 
          ...
          (this.state.count == 0) ? EmptyPeopleProspectsPanel(null)  : "", 
