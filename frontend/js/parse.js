...
var Parse = {
  ...
  _current_user: JSON.parse(localStorage.currentUser),
  _company: JSON.parse(localStorage.currentUser).user_company,
  _user_company: JSON.parse(localStorage.currentUser).user_company,
  headers: {
  ...
  _user: { __type:'Pointer', className: '_User', objectId:  JSON.parse(localStorage.currentUser).objectId},
