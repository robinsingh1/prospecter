...
module.exports = React.createClass({
  ...
  createProfile: function() {
    ...
    console.debug("PROFILE NAME")
    console.debug(profileName)
...
var IndustryMenu = React.createClass({
  ...
  render: function() {
    revenues = _.map(Jigsaw._annual_revenue(), function(val, key) {
      return <SelectGroup name={key} value={val} />
    })
...
var SelectGroup = React.createClass({
  ...
  render: function() {
    ...
    selects = <span> {plus_btn}
              ...
              <input type="checkbox" id="inlineCheckbox1" value={this.props.value}/> 
                {this.props.name}
            </label><br/>
            </span>
